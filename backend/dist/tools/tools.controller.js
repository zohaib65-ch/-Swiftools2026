...
const usage_guard_1 = require("../common/guards/usage.guard");
...
__decorate([
    ...
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), usage_guard_1.UsageGuard),
...
], ToolsController.prototype, "uploadFile", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ToolsController.prototype, "getStatus", null);
